...
# Images
ship_img = pygame.image.load(current_path  + '/assets/images/ship.png')
ship2_img = pygame.image.load(current_path  + '/assets/images/ship_hurt.png')
ship3_img = pygame.image.load(current_path  + '/assets/images/ship_hurty.png')
lasers_img = pygame.image.load(current_path  + '/assets/images/comet.png')
crit_img = pygame.image.load(current_path  + '/assets/images/crit.png')
enemy_img = pygame.image.load(current_path  + '/assets/images/vel.png')
bomb_img = pygame.image.load(current_path  + '/assets/images/bomb.png')
bomb1_img = pygame.image.load(current_path  + '/assets/images/bomb1.png')
bomb2_img = pygame.image.load(current_path  + '/assets/images/bomb2.png')
bomb3_img = pygame.image.load(current_path  + '/assets/images/bomb3.png')
splash = pygame.image.load(current_path  + '/assets/images/start.jpg')
back = pygame.image.load(current_path  + '/assets/images/back.jpg')
end = pygame.image.load(current_path  + '/assets/images/end.jpg')
ship_images = [ship_img, ship2_img, ship3_img]

# Sound
wavestart = pygame.mixer.Sound(current_path  + "/assets/sound/wave.ogg")
explosion = pygame.mixer.Sound(current_path  + "/assets/sound/hitvel.ogg")
grunt = pygame.mixer.Sound(current_path  + "/assets/sound/grunt.ogg")
hitlee = pygame.mixer.Sound(current_path  + "/assets/sound/hitlee.ogg")
hitvel = pygame.mixer.Sound(current_path  + "/assets/sound/fart1.ogg")
shippow = pygame.mixer.Sound(current_path  + "/assets/sound/pow.ogg")
firegirl = pygame.mixer.Sound(current_path  + "/assets/sound/shootgirl.ogg")
firecrit = pygame.mixer.Sound(current_path  + "/assets/sound/firecrit.ogg")

#Fonts
SCORE = pygame.font.Font(current_path  + "/assets/fonts/score.ttf", 32)
ENDSCORE = pygame.font.Font(current_path  + "/assets/fonts/endscore.ttf", 34)
...
def soundef():
    if stage == START:
        return pygame.mixer.music.load(current_path  + "/assets/sound/introsong.ogg")
    elif stage == PLAYING:
        return pygame.mixer.music.load(current_path  + "/assets/sound/godfist.ogg")
    elif stage == END:
        return pygame.mixer.music.load(current_path  + "/assets/sound/endsong.ogg")
